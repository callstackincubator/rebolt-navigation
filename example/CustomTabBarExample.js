...
var CustomTabBar$RerouteNative = require("./CustomTabBar.js");
var NavigationConfig$RerouteNative = require("./NavigationConfig.js");

var component = ReasonReact.statelessComponent("CustomTabBarExample");
              ...
              return ReasonReact.element(/* None */0, /* None */0, Curry.app(NavigationConfig$RerouteNative.StackNavigator[/* Screen */3][/* make */0], [
                              ...
                              (function () {
                                  return ReasonReact.element(/* None */0, /* None */0, Curry._6(NavigationConfig$RerouteNative.TabNavigator[/* make */0], /* ContactList */8, /* array */[
                                                  ...
                                                  /* Messages */9,
                                                  /* About */6
                                                ], /* Some */[(function (tabBarProps) {
                                                      return ReasonReact.element(/* None */0, /* None */0, CustomTabBar$RerouteNative.make(tabBarProps, /* array */[]));
                                                    })], /* None */0, /* None */0, (function (navigation) {
                                                    var match = navigation[/* currentRoute */1];
                                                    var exit = 0;
                                                    if (match >= 8) {
                                                      switch (match - 8 | 0) {
                                                        case 0 : 
                                                            return ReasonReact.element(/* None */0, /* None */0, ContactList$RerouteNative.make(navigation, nav, true, /* array */[]));
                                                        case 1 : 
                                                            return ReasonReact.element(/* None */0, /* None */0, Messages$RerouteNative.make(navigation, true, /* array */[]));
                                                        case 2 : 
                                                            exit = 1;
                                                            break;
